...
Qt.py enables you to write software that runs on any of the supported bindings - PySide2, PyQt5, and PySide6
...
| Date     | Version   | Event
|:---------|:----------|:----------
| TBD      | [2.0.0][] | Removed Qt4 bindings (PySide and PyQt4)
